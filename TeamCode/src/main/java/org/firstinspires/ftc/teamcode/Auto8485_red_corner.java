...
@Autonomous(name="Auto8485_red_corner", group="8485")
public class Auto8485_red_corner extends LinearOpMode {
    DcMotor frontLeft;
    DcMotor frontRight;
    DcMotor backLeft;
    DcMotor backRight;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(time.seconds() < 5.6) {}// 2 seconds - move backwards
        ...
        while(time.seconds() < 6) {} // .4 seconds turn right
        ...
        while(time.seconds() < 8) {} // 1.9 seconds move backward
